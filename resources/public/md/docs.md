...
Two middleware functions are provided by default in the `downnotifier.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `downnotifier.handler` namespace to manage the enabled middleware.
